...
void Forces_MTS::update_Forces(const vector<double> &Q,const vector<double> &P,
   ...
   // std::cout << std::endl;
   // std::cout << "PSV passed to update_Forces" << std::endl;
...
//    std::cout << ThetaMTS->get_theta() << std::endl << std::endl;
//
//    std::cout << "dThetadQ" << std::endl;
//    std::cout << dThetaMTS_dQ->get_dThetaMTS_dQ_vec() << std::endl << std::endl;
//
//    std::cout << "dThetadx" << std::endl;
//    std::cout << dThetaMTS_dElec->get_dThetaMTS_dx_vec() << std::endl << std::endl;
//
//    std::cout << "dThetadp" << std::endl;
//    std::cout << dThetaMTS_dElec->get_dThetaMTS_dp_vec() << std::endl << std::endl;
...
void Forces_MTS::update_dHdP(const vector<double> &P){
   ...
   // std::cout << "P inside update_dHdP" << std::endl;
   // std::cout << P << std::endl;
    dHdP = ONE_mass * P;
}
