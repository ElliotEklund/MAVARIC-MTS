...
clean_me(nuc_beads,file_root,"Q0",X_final)
clean_me(nuc_beads,file_root,"P0",X_final)
clean_me(elec_beads*num_states,file_root,"xelec0",X_final)
clean_me(elec_beads*num_states,file_root,"pelec0",X_final)
