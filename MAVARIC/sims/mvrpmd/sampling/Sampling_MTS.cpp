...
//    quickConvert << my_id;
//
//    std::string fileName = root + "Output/Trajectories/Q" + quickConvert.str();
//
//
//
//    std::ofstream myFile;
...
//    quickConvert << my_id;
//
//    std::string fileName = root + "Output/Trajectories/xelec" + quickConvert.str();
//
//    std::ofstream myFile;
//    myFile.open(fileName);
//
...
//    quickConvert << my_id;
//
//    std::string fileName = root + "Output/Trajectories/pelec" + quickConvert.str();
//
//    std::ofstream myFile;
//    myFile.open(fileName);
//
...
//    quickConvert << my_id;
//
//    std::string fileName = root + "Output/Trajectories/P" + quickConvert.str();
//
//    std::ofstream myFile;
//    myFile.open(fileName);
//
