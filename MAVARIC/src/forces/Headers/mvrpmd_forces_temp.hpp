#ifndef mvrpmd_forces_temp_hpp
#define mvrpmd_forces_temp_hpp
...
public:
    ...
    virtual double get_sgnTheta(const vector<double> &Q, const matrix<double> &x,
